...
<head>
	...
	//Chama a rotina que carrega os parametros passados pela rotina entrada.php
...
<body>
   <?php
	   ...
	   // Pega o cpf do usuario de entre as variaveis globais da sessao 
	   $cpf_usuario = $_SESSION['cpf_m'];
	   
	   //Pega o nome do USUARIO de entre as variaveis globais da sessao
	  ...
	  /* require_once('CabecalhoInterno.php');
	   $cabecalho = new CabecalhoInterno($modulo,$nome_usu);
	   $mostrar  = $cabecalho ->MontaCabeca();*/
